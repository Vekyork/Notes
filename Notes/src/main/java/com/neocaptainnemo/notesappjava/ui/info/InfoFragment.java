...
public class InfoFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getChildFragmentManager().setFragmentResultListener(AlertDialogFragment.RESULT, getViewLifecycleOwner(), (requestKey, result) -> Snackbar.make(requireView(), "Positive", Snackbar.LENGTH_SHORT).show());
    ...
    private void showCustomViewDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(requireContext())
                ...
                .setView(view)
                .setPositiveButton(R.string.select, (dialog, which) -> Snackbar.make(requireView(), editText.getText(), Snackbar.LENGTH_SHORT).show());
