package com.neocaptainnemo.notesappjava.ui.auth;
...
public class AuthFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.signin).setOnClickListener(view1 -> {
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == AUTH_REQUEST_ID){
            ...
            try {
                ...
                Toast.makeText(requireContext(), "Неверная аутентификация", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
